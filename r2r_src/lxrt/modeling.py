...
# }
PRETRAINED_MODEL_ARCHIVE_MAP = {
    'bert-base-uncased': "pytorch_pretrained_bert/bert-base-uncased.tar.gz",
    'bert-large-uncased': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-large-uncased.tar.gz",
    'bert-base-cased': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-cased.tar.gz",
    'bert-large-cased': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-large-cased.tar.gz",
    'bert-base-multilingual-uncased': "https://s3.amazonaws.com/models.huggingface.co/bert/bert-base-multilingual-uncased.tar.gz",
...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.word_embeddings = nn.Embedding(config.vocab_size, config.bert_emb_hidden_size, padding_idx=0)
        self.position_embeddings = nn.Embedding(config.max_position_embeddings, config.bert_emb_hidden_size, padding_idx=0)
        self.token_type_embeddings = nn.Embedding(config.type_vocab_size, config.bert_emb_hidden_size, padding_idx=0)

        # self.LayerNorm is not snake-cased to stick with TensorFlow model variable name and be able to load
        # any TensorFlow checkpoint file
        self.LayerNorm = BertLayerNorm(config.bert_emb_hidden_size, eps=1e-12)
...
class LXRTModel(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.fc1 = nn.Linear(config.bert_emb_hidden_size, config.hidden_size)
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None,
        ...
        embedding_output = self.relu1(self.fc1(embedding_output))
