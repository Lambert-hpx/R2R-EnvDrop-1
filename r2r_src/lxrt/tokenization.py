...
PRETRAINED_VOCAB_ARCHIVE_MAP = {
    ...
    'bert-base-multilingual-uncased': "pytorch_pretrained_bert/bert-base-multilingual-uncased-vocab.txt",
    'bert-base-multilingual-cased': "pytorch_pretrained_bert/bert-base-multilingual-cased-vocab.txt",
    'bert-base-chinese': "pytorch_pretrained_bert/bert-base-chinese-vocab.txt",
}
